...
HD_PWD='D:/Work/vivado_project/MiniMIPS32_Lite_FullSyS/MiniMIPS32_Lite_FullSyS.runs/clk_sync_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_sync.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_sync.tcl
